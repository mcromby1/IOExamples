 ...
 *
 * A class that reads data from a text file, with buffering. Uses the file
...
public class TextReaderApp {
    ...
    public static void main(String[] args) throws Exception{
        ...
        if (file.exists()) //	File file = new File(File.separatorChar + "temp" + File.separatorChar 
        //                        + "test.txt");
        //                + "test.txt");
         ...
         */ //	File data = new File("/temp/example.txt");  // Windows or Unix/Linux
        	file = new File("C:\\temp\\example.txt");  // Windows only
